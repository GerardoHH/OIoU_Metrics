...
### Real-World Datasets
- **MNIST**: 60,000 training images, 10,000 test images, 784 features (28x28 pixels), 10 classes      DOI:[10.24432/C53K8Q](https://doi.org/10.24432/C53K8Q)
- **Letter Recognition**: 20,000 samples, 16 numerical features, 26 classes (A-Z)                     DOI: [10.24432/C5ZP40](https://doi.org/10.24432/C5ZP40)
...
- **Artificial Characters**: Murphy's artificial character dataset with 36 features, 10 character classes DOI: ([10.24432/C5303Z](https://doi.org/10.24432/C5303Z))
## Code Information
